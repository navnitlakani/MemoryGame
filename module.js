    ...
    app.controller('AppController', ['$scope', '$timeout', 'DataService', function ($scope, $timeout, DataService) {
    ...
    app.factory('DataService', [function () {
        ...
        var service = {
            ...
            isGameOver: function () {
                if (service.data.timerOut == true || service.data.pairs_completed === service.mode.x * service.mode.y / 2) {
